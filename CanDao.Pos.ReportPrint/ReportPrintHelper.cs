    ...
    public class ReportPrintHelper
    {
        ...
        public static bool PrintClearPosReport(string userId)
        {
            ...
            try
            {
                ...
                AddObject2DataTable(mainDb, result.Item2.OrderJson.First());

                var settDb = CreateClearPosSettlementDb();
                if (result.Item2.JSJson != null && result.Item2.JSJson != null)
                    result.Item2.JSJson.ForEach(t => AddObject2DataTable(settDb, t));

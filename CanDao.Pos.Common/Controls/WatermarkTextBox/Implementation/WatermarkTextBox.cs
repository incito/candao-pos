...
namespace CanDao.Pos.Common.Controls
{
    public class WatermarkTextBox : TextBox
    {
        ...
        public static readonly DependencyProperty SelectAllOnGotFocusProperty = DependencyProperty.Register("SelectAllOnGotFocus", typeof(Boolean), typeof(WatermarkTextBox), new PropertyMetadata(false));
        public Boolean SelectAllOnGotFocus
        {
            get
            {
                return (Boolean)GetValue(SelectAllOnGotFocusProperty);
            }
            set
            {
